...
extension AppL10n {
    static let chineseSupplement: [String: String] = [
        "Provider template": "供应商模板",
        "Required": "必填",
        "optional": "可选",
        "Choose a provider to fill in its fields, or enter a key manually below.": "选择供应商，自动带出对应字段；也可以直接在下方手动填写。",
        ...
        "The selected template is unavailable. Choose another provider.": "所选模板不可用，请重新选择供应商。",
        ...
        "Save checks required fields and documented formats, not whether the provider accepts the key.": "保存时检查必填项和已知格式，不代表密钥已通过供应商验证。",
